class ConferenceDatatable < AjaxDatatablesRails::Base
  ...
  def_delegators :@view, :link_to, :admin_publication_authors_path,:link_to, :edit_admin_conference_path, :link_to, :admin_publication_path, :content_tag, :link_to_button_column
  ...
  def data
    records.map do |record|
      [
          ...
          link_to_button_column(("<i class='fa fa-pencil'></i> Edit").html_safe, edit_admin_conference_path(record), remote: true,
                  class:"btn btn-info btn-xs editButton", onclick: 'editButtonPressed("Conference")'),
#, data: { tdclass: "buttonColumn" }
