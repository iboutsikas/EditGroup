class ProjectDatatable < AjaxDatatablesRails::Base
  ...
  def_delegators :@view, :link_to, :content_tag,:admin_project_path,:link_to,
  :edit_admin_project_path, :link_to, :admin_project_participations_path,
  ...
  def data
    records.map do |record|
      [
        ...
        link_to_button_column(("<i class='fa fa-users'></i> Participants").html_safe, admin_project_participations_path(record),
            class: "btn btn-default btn-xs participantsButton", id: "participantButton"),

        link_to_button_column(("<i class='fa fa-pencil'></i> Edit").html_safe, edit_admin_project_path(record), remote: true,
                class:"btn btn-info btn-xs editButton", onclick: 'editButtonPressed("Project")'),

        link_to_button_column(("<i class='fa fa-trash-o'></i> Delete").html_safe, admin_project_path(record), method: :delete,
