...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { administrative_title: @participation.administrative_title, email: @participation.email }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { administrative_title: @participation.administrative_title, email: @participation.email }
    assert_redirected_to participation_path(assigns(:participation))
  end
